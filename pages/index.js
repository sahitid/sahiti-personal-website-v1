      ...
      <main className="flex flex-col w-full bg-[#6865D1] h-screen">
        ...
        <section className="max-w-4xl	ml-10 my-10 grow text-[#D7C4E0]">
          ...
          <p className="inter text-base">
            Hi! I'm a student and full stack developer in love with the world of
            computer science and entrepreneurship. My mission is to make an
            impact by spreading opportunities. Feel free to connect with me at
            any of the links below or contact me at{" "}
            <a href="mailto:sahiti@hackclub.com" target="_blank">
              <u>sahiti@hackclub.com</u>
            </a>
            .<br></br>
            <br></br>
            What keeps me going? The belief that when we blend creativity with
            purpose, we can sculpt a better world. And it's not just about
            changing the world; it's about having a blast while doing it!
          </p>
          <br></br>
          <br></br>
          ...
          <div className="flex flex-row gap-2">
            <a href="https://www.linkedin.com/in/sahitidasari/" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
                height="50"
            ...
            <a href="https://github.com/sahitid" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
                height="50"
